...
class Challenge extends Component {
  render() {
    return <div className="challenge">
        <h2 className
        ="challengeTitle">VIÐ SKORUM Á ÞIG</h2>
        <div className="challengeContent">
        <ScrollAnimation animateIn='animate__animated animate__fadeInUp' className="animation">
          <div className="challengeImage">
            <img src={instastory} alt="instastory" width="200" height="200"></img>
          </div>
        </ScrollAnimation>
